    ...
    <form method="post" enctype="multipart/form-data" class="p-5 form-gorup">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="text" name="numOs" class="form-control border-0" placeholder="Digite o numero da OS"
                    required><br><br>
            </div>
            <div class="col-6">
                <label for="numOrcamento" class="form-label">Número Orçamento:</label>
                <input type="text" name="numOrcamento" class="form-control border-0"
                    placeholder="Digite o Número do Orçamento" required><br><br>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <select name="idCliente" id="idCliente" class="form-control border-light text-muted" required
                    onchange="toggleNovoCliente(this)">
                ...
                <div id="novoClienteContainer" style="display: none;">
                    ...
                    <input type="text" name="novoCliente" id="novoCliente" class="form-control border-0"
                        placeholder="Digite o nome do novo cliente"><br><br>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" name="titulo" class="form-control border-0" placeholder="Digite o titulo do trabalho"
                    required><br><br>
            </div>
            ...
            <div class="col">
                ...
                <textarea name="observacoes" class="form-control" placeholder="Digite a descrição do trabalho"
        ...
        <div class="row">
            ...
            <div class="col-2">
                <input type="number" name="min" id="min" class="w-50 border-0" value="0" placeholder="00" max="59">
                Minutos
            </div>
        </div>
